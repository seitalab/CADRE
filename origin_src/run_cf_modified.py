...
# --batch_size default 8 →　4
# --test_batch_size default 8　→　４
# --repository default ccle →　gdsc
# --model_label default cntx-attn-gdsc
...
parser.add_argument("--batch_size", help="training batch size", type=int, default=4)#256
parser.add_argument("--test_batch_size", help="test batch size", type=int, default=4)
